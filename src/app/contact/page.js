...
export default function ContactPage() {
  ...
  const boutiqueLocation = "123 Heritage Lane, Fashion District, Mumbai, MH 400001, India";
  const mapExternalUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(boutiqueLocation)}`;
    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="bg-gradient-premium py-20 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 75% 50%, #D4AF37 0%, transparent 60%)",
          }}
        />
        <div className="container mx-auto px-6 md:px-12 text-center relative z-10">
          ...
          <p className="text-white/60 mt-4 max-w-xl mx-auto">
            Have a question, custom order inquiry, or just want to say hello?
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-6xl py-20">
        ...
        {/* Map Section */}
        <div className="mb-16 rounded-sm overflow-hidden shadow-luxury h-[400px] md:h-[500px]">
          <GoogleMap location={boutiqueLocation} />
        </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            <div className="bg-gradient-premium p-8 rounded-sm text-white">
              ...
              <p className="text-white/70 text-sm mb-6 leading-relaxed">
                Get instant responses from our boutique team. We're available
                Mon–Sat, 10am to 8pm.
              </p>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="btn-gold rounded-sm inline-flex-  gap-2 text-sm w-full justify-center"
              >
                <svg
                  width="18"
                  height="18"
            ...
            <div className="glass-card p-8 rounded-sm">
              ...
              <div className="space-y-3 text-sm">
                {[
                  ...
                  <div
                    key={day}
                    className="flex justify-between items-center border-b border-[#E2C2C6]/30 pb-2"
                  >
