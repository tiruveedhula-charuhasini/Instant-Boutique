...
// Custom WhatsApp SVG icon to avoid lucide-react brand issues
...
export default function WhatsAppButton() {
  ...
  const defaultMessage = "Hello Instant Boutique! I would like to know more about your collections.";
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.4)] flex items-center justify-center hover:bg-[#22c35e] transition-colors"
